              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative group cursor-help flex items-center mt-2" tabIndex={0}>
                    ...
                    <div className="absolute right-0 md:left-0 md:right-auto top-full mt-2 hidden group-hover:block group-focus-within:block w-[280px] md:w-72 p-4 bg-[#0A192F] text-[#D8DADC] text-[12px] font-normal rounded-lg shadow-xl z-50 leading-relaxed">
                      ...
                      <div className="absolute right-1.5 md:left-1.5 md:right-auto bottom-full border-4 border-transparent border-b-[#0A192F]"></div>
                    </div>
                  </div>
                </div>
